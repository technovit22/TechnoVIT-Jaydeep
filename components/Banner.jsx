...
const Banner = () => {
  return (
    <>
      <motion.div variants={outerVariant} initial={"hidden"} visible={"visible"} className="bg-natureBg1 -z-40 bg-cover bg-no-repeat font-spaceMono w-full h-[100vh] space-y-[3.4rem]">
